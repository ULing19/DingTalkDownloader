...
; 源文件目录：dist\DingTalkDownloader_1.2.1（由 build_exe.bat 生成）
...
#define ReleaseDir "..\dist\DingTalkDownloader_1.2.1"
...
OutputBaseFilename=DingTalkDownloader_1.2.1_Setup

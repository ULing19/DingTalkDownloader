...
; 源文件目录：dist\DingTalkDownloader_1.3.7（由 build_exe.bat 生成）
...
#define ReleaseDir "..\dist\DingTalkDownloader_1.3.7"
...
OutputBaseFilename=DingTalkDownloader_1.3.7_Setup

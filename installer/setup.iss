...
; 源文件目录：dist\DingTalkDownloader_1.3.8（由 build_exe.bat 生成）
...
#define ReleaseDir "..\dist\DingTalkDownloader_1.3.8"
...
OutputBaseFilename=DingTalkDownloader_1.3.8_Setup
